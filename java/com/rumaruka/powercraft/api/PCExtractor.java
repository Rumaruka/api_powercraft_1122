...
public class PCExtractor {
    ...
    public static void extract(File source) {
        if(source.isFile()){
            try {
                ...
                PCLogger.severe("I am not a jar nor zip");
            }
    ...
    private static void extractZip(ZipFile zip) {
        ...
        while(entries.hasMoreElements()){
            ...
            if(name.startsWith("def\\") || name.startsWith("def/")){
                ...
                File file = PCUtils.getPowerCraftFile(null, name);
                ...
                try{
                    ...
                    PCLogger.severe("Error while copy def file");
                }
            }
        }
    }
    ...
    private static void extractDir(File source) {
        ...
        copy(def, PCUtils.getPowerCraftFile(null, "tmp").getParentFile());
    }
