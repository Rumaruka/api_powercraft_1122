...
import com.rumaruka.powercraft.api.gres.autoadd.PCSortedList;

public class PCValueRangeI {
    ...
    private PCSortedList<Range> ranges = new PCSortedList<Range>();
    ...
    public void addRange(PCValueRangeI range){
    ...
    public static PCValueRangeI pharseRange(String str){
        String[] splits = str.trim().split("\\s*,\\s*");
        PCValueRangeI range = new PCValueRangeI();
