...
public class PCImmutableList<E> implements List<E> {
    private List<E> list;
    private int start;
    private int end;

    public PCImmutableList(List<E> list){
        this.list = list;
        this.start = 0;
        this.end = list.size();
    }

    private PCImmutableList(List<E> list, int start, int end){
        this.list = list;
        this.start = start;
        this.end = end;
    }
    ...
    public List<E> subList(int start, int end) {
        ...
        return new PCImmutableList<E>(this.list, this.start+start, this.start+end);
    }
